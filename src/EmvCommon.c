...
//paypass 
	...
	tempCAPK.HashInd = 1;
	tempCAPK.ArithInd = 1;
	AscToBcd_Api(tempCAPK.ExpDate, "281231", 6);
	AscToBcd_Api(tempCAPK.RID, "A000000004", 10);
	tempCAPK.KeyID = 0x06;
	tempCAPK.ModulLen = 496/2;
	AscToBcd_Api(tempCAPK.Modul, "", 496);
	tempCAPK.ExponentLen = 1;
	AscToBcd_Api(tempCAPK.Exponent, "03", tempCAPK.ExponentLen*2);
	AscToBcd_Api(tempCAPK.CheckSum, "F910A1504D5FFB793D94F3B500765E1ABCAD72D9", 40);
	ret = Common_AddCapk_Api(&tempCAPK);
...
WAVE_SELECT_NEXT:
	...
	Common_GetTLV_Api(0x9C, sTemp, &iLength);
	memset(ascBuff, 0, sizeof(ascBuff));
	BcdToAsc_Api(ascBuff, sTemp, iLength * 2);
//	TipAndWaitEx_Api("9C: %s", ascBuff);

	Common_GetTLV_Api(0x5F2A, sTemp, &iLength);
	memset(ascBuff, 0, sizeof(ascBuff));
	BcdToAsc_Api(ascBuff, sTemp, iLength * 2);
//	TipAndWaitEx_Api("5F2A: %s", ascBuff);

	Common_GetTLV_Api(0x9F1A, sTemp, &iLength);
	memset(ascBuff, 0, sizeof(ascBuff));
	BcdToAsc_Api(ascBuff, sTemp, iLength * 2);
//	TipAndWaitEx_Api("9F1A: %s", ascBuff);
...
void initPayPassWaveConfig(int transType)
{
	...
	AscToBcd_Api(termParam.CountryCode, "0356", 4);
	AscToBcd_Api(termParam.TransCurrCode, "0356", 4);
	AscToBcd_Api(termParam.ReferCurrCode, "0356", 4);

...
{ 
	...
	_tms_MD5Init(&_tms_MD5c); //��ʼ�� 
	_tms_MD5UpdaterString(&_tms_MD5c,"��Ҫ���Ե��ַ���"); 
	_tms_MD5FileUpdateFile(&_tms_MD5c,"��Ҫ���Ե��ļ�·��"); 
	_tms_MD5Final(digest,&_tms_MD5c); 

	//�ڶ����÷�: 
	_tms_MDString("��Ҫ���Ե��ַ���",digest); //ֱ�������ַ������ó���� 

	//�������÷�: 
	_tms_MD5File("��Ҫ���Ե��ļ�·��",digest); //ֱ�������ļ�·�����ó���� 
}
*/
